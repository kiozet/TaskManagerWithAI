...
def taskDataInsert(title, desription, dateCreated, deadline, cursor: sqlite3.Cursor):
    try:
        connection = sqlite3.connect("project.db")
...
def registrationDataInsert(email, login, password, cursor: sqlite3.Cursor) -> bool:
    connection = sqlite3.connect("users.db")
    try:
...
def profileDataInsert(telegrammID, name, surname, photo, cursor: sqlite3.Cursor):
    connection = sqlite3.connect("users.db")
    try:
...
def deleteTaskTable(title, cursor: sqlite3.Cursor):
    connection = sqlite3.connect("project.db")
...
def changeTasksStatus(tasksTitle, columnName, cursor: sqlite3.Cursor) -> bool:
    connection = sqlite3.connect("project.db")
...
def changePassword(login, newPassword, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def changeLogin(oldLogin, newLogin, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def changeEmail(oldEmail, newEmail, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def updateTitle(oldTitle, newTitle, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("project.db")
...
def updateDescription(tasksTitle, newDescription, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("project.db")
...
def updateDeadlineTask(tasksTitle, newDeadline, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("project.db")
...
def updatePhoto(login, newPhoto, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def updateName(login, newName, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def updateSurname(login, newSurname, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
...
def updateTelegrammId(login, newId, cursor: sqlite3.Cursor) -> bool:
    try:
        connection = sqlite3.connect("users.db")
